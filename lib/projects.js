...
export const SEED_PROJECTS = [
  {
    ...
    status: 'en-progreso',
    progrexport const SEED_PROJECTS = [
  {
    slug: 'ejemplo-app-de-reservas',
    icon: '🚀',
    name: 'Ejemplo: App de Reservas',
    status: 'en-progreso',
    progress: 40,
    notes: 'Este es un proyecto de ejemplo. Edítalo, bórralo o crea el tuyo con el botón "+".',
  },
  {
    slug: 'ejemplo-tienda-online',
    icon: '🗂️',
    name: 'Ejemplo: Tienda Online',
    status: 'idea',
    progress: 0,
    notes: 'Otro proyecto de ejemplo para que veas cómo se ve la consola con más de una tarjeta.',
  },
];
